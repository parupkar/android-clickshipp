...
import com.clickshipp.shop.fragments.Order_Details;
...
public class OrdersListAdapter extends RecyclerView.Adapter<OrdersListAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.order_price.setText(orderDetails.getCurrency() + new DecimalFormat("#0.00").format(Double.parseDouble(orderDetails.getTotal())));
