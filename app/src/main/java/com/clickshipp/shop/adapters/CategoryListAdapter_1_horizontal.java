...
import com.clickshipp.shop.fragments.SubCategories_1;
...
public class CategoryListAdapter_1_horizontal extends RecyclerView.Adapter<CategoryListAdapter_1_horizontal.MyViewHolder> {

    boolean isSubCategory, isSmall;

    Context context;
    List<CategoryDetails> categoriesList;


    public CategoryListAdapter_1_horizontal(Context context, List<CategoryDetails> categoriesList, boolean isSubCategory, boolean isSmall) {
    ...
    public MyViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View itemView;
        if (isSmall){
            itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_categories_1_horizontal_small, parent, false);
        } else {
            itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_categories_1_horizontal, parent, false);
        }
