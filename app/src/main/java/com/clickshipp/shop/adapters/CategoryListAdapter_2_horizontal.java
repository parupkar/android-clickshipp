...
import com.clickshipp.shop.fragments.SubCategories_2;
...
public class CategoryListAdapter_2_horizontal extends RecyclerView.Adapter<CategoryListAdapter_2_horizontal.MyViewHolder> {
    ...
    public CategoryListAdapter_2_horizontal(Context context, List<CategoryDetails> categoriesList, boolean isSubCategory) {
    ...
    public MyViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_categories_2_horizontal, parent, false);
