...
import com.clickshipp.shop.customs.FilterDialog;
...
public class All_Products extends Fragment {
    ...
    boolean isBottomBarDisabled = false;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable Bundle savedInstanceState) {
      ...
      /*  MainActivity activity = (MainActivity) getActivity();
        ...
        Log.e("myData",myDataFromActivity);*/
        ...
        if (getArguments() != null) {
            ...
            if (getArguments().containsKey("is_bottombar_dissabled")){
                isBottomBarDisabled = getArguments().getBoolean("is_bottombar_dissabled", false);
            }
        }
    ...
    public void RequestFilters(final PostFilters postFilters) {
        ...
        String lang = ConstantValues.LANGUAGE_CODE;
        ...
        if (postFilters != null) {
            if (postFilters.getMaxPrice() != null  &&  !TextUtils.isEmpty(postFilters.getMaxPrice()))
                params.put("max_price_new", ""+postFilters.getMaxPrice());
    
            if (postFilters.getMinPrice() != null  &&  !TextUtils.isEmpty(postFilters.getMinPrice()))
                params.put("min_price_new", ""+postFilters.getMinPrice());
        ...
        call.enqueue(new Callback<ProductFilters>() {
            ...
            public void onResponse(Call<ProductFilters> call, retrofit2.Response<ProductFilters> response) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        String responseBdy = response.body().toString();
