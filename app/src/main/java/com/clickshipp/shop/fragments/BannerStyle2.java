...
import com.clickshipp.shop.adapters.BannerStyle2Adapter;
import com.clickshipp.shop.customs.BannerStyle2ViewPager;
...
public class BannerStyle2 extends Fragment {
    ...
    private void addFragments(List<BannerDetails> banners) {
        ...
        for (int i = 0; i < banners.size(); i++) {
            ...
            BannerItemFragment fragment = new BannerItemFragment(banner.getBannersImage());
            adapter.addFrag(fragment, banner.getBannersTitle());
        }
