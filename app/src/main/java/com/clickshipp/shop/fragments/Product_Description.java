...
import com.clickshipp.shop.adapters.GroupedProductsAdapter;
import com.clickshipp.shop.adapters.ProductAdapter;
import com.clickshipp.shop.adapters.ProductAttributesAdapter;
import com.clickshipp.shop.adapters.ProductReviewsAdapter;
...
import com.clickshipp.shop.customs.DividerItemDecoration;
import com.clickshipp.shop.databases.User_Favorites_DB;
...
import com.clickshipp.shop.models.product_model.ProductAttributes;
import com.clickshipp.shop.models.product_model.ProductDetails;
import com.clickshipp.shop.models.product_model.ProductImages;
...
import com.clickshipp.shop.utils.ValidateInputs;
...
public class Product_Description extends Fragment implements BaseSliderView.OnSliderClickListener {
    ...
    ProgressBar relatedProductsProgress;
    ...
    LinearLayout product_reviews_ratings, product_attributes, simple_product, grouped_products, product_metadata, product_description,
            seller_div;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        product_tag_new = (TextView) rootView.findViewById(R.id.product_item_tag_new);
        ...
        related_products = (RelativeLayout) rootView.findViewById(R.id.related_products);
        ...
        relatedProductsProgress = rootView.findViewById(R.id.relatedProductsProgress);
                ...
                if ("1".equalsIgnoreCase(appSettings.getDokan_enabled())) {
                    if (productDetails.getStore() != null) {
                        ...
                        store_btn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                bundle.putInt(ConstantValues.SELLER_ID, sellerID);
                                bundle.putString(ConstantValues.SELLER_NAME, sellerName);
                                bundle.putString(ConstantValues.SELLLER_RATING, seller_rating);
                                bundle.putString(ConstantValues.SELLET_PICTURE, seller_pic);
                                bundle.putString(ConstantValues.SELLER_EMAIL, seller_email);
                                bundle.putString(ConstantValues.mvf_enabled, "1");
                        ...
                        //Snackbar.make(rootView,getString(R.string.dukan_plugin_warning),Snackbar.LENGTH_LONG).show();
                    }
                } else if ("2".equalsIgnoreCase(appSettings.getDokan_enabled())) {
                    seller_div.setVisibility(View.VISIBLE);
                    RequestSellerInfo(productDetails.getId());
                    ...
                    store_btn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Get Product Info
                            Bundle bundle = new Bundle();
                            bundle.putInt(ConstantValues.SELLER_ID, Integer.parseInt(sellerIDWC));
                            bundle.putString(ConstantValues.SELLER_NAME, sellerNameWC);
                            bundle.putString(ConstantValues.SELLER_EMAIL, sellerEmailWC);
                            bundle.putString(ConstantValues.mvf_enabled, "2");
        ...
        call.enqueue(new Callback<SellerInfoWC>() {
            ...
            public void onResponse(Call<SellerInfoWC> call, Response<SellerInfoWC> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    sellerIDWC = sellerInfoWC.getData().getID();
        ...
        call.enqueue(new Callback<SellerDetailModel>() {
            ...
            public void onResponse(Call<SellerDetailModel> call, Response<SellerDetailModel> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    seller_rating = String.valueOf(sellerDetailModel.getRating().getCount());
                    seller_email = "email";
    ...
    private void setProductDetails(final ProductDetails product) {
        ...
        title.setText(productDetails.getName().replace("&amp;", "&"));
        ...
        Log.d("Rating", String.valueOf(productDetails.getRatingCount()));
...
//                            cartDetails.setCustomersBasketProductAttributes(selectedAttributesList);
                            ...
                            My_Cart.AddCartItemID(cartDetails.getCartProduct().getId(), number[0]);
                        }
                    }
...
//                        cartDetails.setCustomersBasketProductAttributes(selectedAttributesList);
        ...
        toolbar_ic_share.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                ...
                if (getArguments().containsKey("itemID")) {
                    ...
                    DeepLinking.createDeepLink(getActivity(), getContext(), "" + productID, true);

                } else if (getArguments().containsKey("productDetails")) {
                    productDetails = getArguments().getParcelable("productDetails");
                    DeepLinking.createDeepLink(getActivity(), getContext(), "" + productDetails.getId(), true);
                }
                return false;
            }
        });
    ...
    public void updateProductPrices() {
        ...
        String code = ConstantValues.CURRENCY_SYMBOL;
    }
    ...
    public void RequestRelatedProducts(int products_id) {
        ...
        call.enqueue(new Callback<ProductDetails>() {
            @Override
            public void onResponse(Call<ProductDetails> call, retrofit2.Response<ProductDetails> response) {
                if (relatedProductsProgress.getVisibility() == View.VISIBLE)
