package com.clickshipp.shop.customs;
...
import com.clickshipp.shop.adapters.FiltersAdapter;
import com.clickshipp.shop.constant.ConstantValues;
import com.clickshipp.shop.models.product_filters_model.FilterDetails;
...
public abstract class FilterDialog extends Dialog {
    ...
    private String default_min_value = "0.0", default_max_value = "0.0";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (productFilters != null) {
            ...
            filter_min_price.setText(productFilters.getMin_price_new() == null ? "0" : productFilters.getMin_price_new());
            filter_max_price.setText(productFilters.getMax_price_new() == null ? ConstantValues.FILTER_MAX_PRICE : productFilters.getMax_price_new());
            filter_price_slider.setMinValue(productFilters.getMin_price_new() == null ? Float.parseFloat("0") : Float.parseFloat(productFilters.getMin_price_new()));
            filter_price_slider.setMaxValue(productFilters.getMax_price_new() == null ? Float.parseFloat(ConstantValues.FILTER_MAX_PRICE) : Float.parseFloat(productFilters.getMax_price_new()));

            default_min_value = (productFilters.getMin_price_new() == null) ? "0.0" : productFilters.getMin_price_new();
            default_max_value = productFilters.getMax_price_new() == null ? ConstantValues.FILTER_MAX_PRICE : productFilters.getMax_price_new();
            ...
            default_max_value = ConstantValues.FILTER_MAX_PRICE;
        }
    ...
    public void submitFilters() {
        ...
        boolean isPriceFilterApplied = false;

        if (Float.parseFloat(filter_min_price.getText().toString()) != Float.parseFloat(default_min_value)
        || Float.parseFloat(filter_max_price.getText().toString()) != Float.parseFloat(default_max_value)) {
            isPriceFilterApplied = true;
        }

        if (!isPriceFilterApplied && selectedFilters.size() < 1
