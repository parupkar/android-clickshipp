package com.clickshipp.shop.models.product_filters_model;
...
public class ProductFilters {
   ...
   /* public String getMessage() {
    ...
    public String getMin_price_new() {
        return min_price_new;
    }
    
    public void setMin_price_new(String min_price_new) {
        this.min_price_new = min_price_new;
    }
    
    public String getMax_price_new() {
        return max_price_new;
    }
    
    public void setMax_price_new(String max_price_new) {
        this.max_price_new = max_price_new;
    }
