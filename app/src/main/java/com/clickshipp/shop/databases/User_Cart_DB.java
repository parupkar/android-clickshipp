package com.clickshipp.shop.databases;
...
public class User_Cart_DB {
    ...
    public void deleteCartItemID(int products_id){
        // get and open SQLiteDatabase Instance from static method of DB_Manager class
        SQLiteDatabase db = DB_Manager.getInstance().openDatabase();
        
        db.delete(TABLE_CART_IDS, PRODUCT_ID +" = ?", new String[]{String.valueOf(products_id)});
